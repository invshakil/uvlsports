...
/* harmony default export */ __webpack_exports__["a"] = (VueToastr$1);
 ...
 * Components
 */
Vue.component('tweet-view', __webpack_require__(37));
...
/* scopeId */
var __vue_scopeId__ = "data-v-12ca36bb"
/* moduleIdentifier (server only) */
...
Component.options.__file = "resources/assets/js/tweets/tweetView.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-12ca36bb", Component.options)
  } else {
    hotAPI.reload("data-v-12ca36bb", Component.options)
  }
...
var update = __webpack_require__(4)("cd8f4880", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-12ca36bb\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./tweetView.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-12ca36bb\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./tweetView.vue");
...
// module
exports.push([module.i, "\n.listing-news .post[data-v-12ca36bb] {\n    max-height: 300px;\n    margin-top: 0;\n}\nimg.logo-class[data-v-12ca36bb] {\n    margin: 0 auto;\n    display: block;\n    padding: 45px;\n    background: #00000013;\n}\n.fa[data-v-12ca36bb]:hover {\n    cursor: pointer;\n}\n.listing-news .post-content .entry-title[data-v-12ca36bb] {\n    margin-bottom: 5px;\n}\n.entry-meta[data-v-12ca36bb] {\n    margin-bottom: 5px;\n}\n", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_infinite_loading__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_toastr__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ...
        'form-modal': __WEBPACK_IMPORTED_MODULE_1__modal___default.a,
        VueToastr: __WEBPACK_IMPORTED_MODULE_2_vue_toastr__["a" /* default */]
    },
    props: {
        tweets: {
            required: true
    ...
    created: function created() {
        var _this = this;
        _this.$eventHub.$on('data-created', function (tweet) {
            _this.results.unshift(tweet);
        });
        _this.$eventHub.$on('data-updated', function (tweet, index) {
            setTimeout(function () {
        ...
        infiniteHandler: function infiniteHandler($state) {
            ...
            axios.get(url, {
                ...
                if (data.length) {
                    ...
                    _this2.page += 1;
                    (_results = _this2.results).push.apply(_results, _toConsumableArray(data));
                    $state.loaded();
                } else {
                    $state.complete();
                }
...
Component.options.__file = "resources/assets/js/tweets/modal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-75e447b2", Component.options)
  } else {
    hotAPI.reload("data-v-75e447b2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("625ee73a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-75e447b2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./modal.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-75e447b2\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./modal.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_modal__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_toastr__ = __webpack_require__(12);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        modal: __WEBPACK_IMPORTED_MODULE_0__components_modal___default.a, VueToastr: __WEBPACK_IMPORTED_MODULE_1_vue_toastr__["a" /* default */]
    },
    mounted: function mounted() {
        var _this = this;
        _this.$eventHub.$on('OpenModal', function (param) {
    ...
    methods: {
        checkValidation: function checkValidation() {
            ...
            if (this.form.image !== '') {
                var result = this.isURL(this.form.image);
                if (!result) {
        ...
        validateBeforeSubmit: function validateBeforeSubmit() {
            var validate = this.checkValidation();
            if (!validate) {
                return false;
            }
        ...
        isURL: function isURL(str) {
            var url = /^(?:\w+:)?\/\/([^\s\.]+\.\S{2}|localhost[\:?\d]*)\S*$/.test(str);
            if (url) {
                var image = new Image();
                image.src = str;
                if (!image.complete) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-514744a6"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
              ...
              [
                _c(
                  "div",
                  {
                    class: {
                      "form-group": true,
                      "has-error": _vm.errors.title.length > 0
                    }
                  },
                  [
                    _c(
                ...
                _c(
                  "div",
                  {
                    class: {
                      "form-group": true,
                      "has-error": _vm.errors.image.length > 0
                    }
                  },
                  [
                    _c(
                    ...
                    _vm.errors.image.length > 0
                      ...
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.form.image !== "" && _vm.errors.image.length === 0
                      ? _c("img", {
                          staticClass: "img-responsive img-thumbnail",
                          attrs: { src: _vm.form.image, alt: "", width: "200" }
                        })
                      : _vm._e()
                  ]
                ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-75e447b2", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("h1", { staticClass: "section-title" }, [
        ...
        _vm.is_allowed
          ? _c(
              "button",
              {
                staticClass: "btn btn-success btn-custom pull-right",
                attrs: { id: "show-modal" },
                on: {
      ...
      _c("form-modal"),
      _vm._v(" "),
      _vm._l(_vm.results, function(tweet, index) {
            ...
            _c("div", { staticClass: "entry-thumbnail" }, [
              tweet.image
                ? _c("img", {
                    ...
                    attrs: { src: tweet.image, alt: tweet.title }
                  })
                : _c("img", {
                    staticClass: "img-responsive img-thumbnail logo-class",
                    attrs: {
                      src: _vm.baseUrl + "/" + "image_upload/system_logo.png",
                      alt: "tweet.title"
                    }
                  })
            ])
          ...
          _c("div", { staticClass: "post-content" }, [
            ...
            _c("div", { staticClass: "entry-meta" }, [
              _c("ul", { staticClass: "list-inline" }, [
                _c("li", { staticClass: "publish-date" }, [
                  _c("a", { attrs: { href: "#" } }, [
            ...
            _c("div", [
              ...
              _vm.is_allowed
                ? _c("i", {
                    ...
                    on: {
                      click: function($event) {
                        return _vm.deleteData(tweet.id, index)
                      }
                    }
                  })
                : _vm._e()
      ...
      _c(
        ...
        [
          _c("div", { attrs: { slot: "no-more" }, slot: "no-more" }, [
            _vm._v("No more tweets available to show.")
          ])
        ]
      ),
      _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-12ca36bb", module.exports)
  }
}
...
var render = function() {
  ...
  return _c("transition", { attrs: { name: "fade" } }, [
    _c(
      "div",
      { staticClass: "modal-mask", attrs: { id: "modal-skew-from-top" } },
      [
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("862e77c2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-514744a6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./modal.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-514744a6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./modal.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.modal-mask[data-v-514744a6] {\n  position: absolute;\n  z-index: 9998;\n  top: 0;\n  /*left: 0;*/\n  width: 100%;\n  height: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n  display: block;\n  transition: opacity .3s ease;\n}\n.modal-mask .modal-wrapper[data-v-514744a6] {\n    display: block;\n    vertical-align: middle;\n}\n.modal-mask .modal-wrapper .modal-container[data-v-514744a6] {\n      width: 800px;\n      margin: 0px auto;\n      padding: 20px 30px;\n      background-color: #fff;\n      border-radius: 2px;\n      box-shadow: 0 2px 8px rgba(0, 0, 0, 0.33);\n      transition: all .3s ease;\n      font-family: Helvetica, Arial, sans-serif;\n}\n.modal-mask .modal-wrapper .modal-container .modal-header h3[data-v-514744a6] {\n        margin-top: 0;\n        color: #42b983;\n}\n.modal-mask .modal-wrapper .modal-container .modal-body[data-v-514744a6] {\n        margin: 20px 0;\n}\n.modal-mask .modal-wrapper .modal-container .modal-default-button[data-v-514744a6] {\n        float: right;\n}\n.fade-enter-active[data-v-514744a6], .fade-leave-active[data-v-514744a6] {\n  transition: all 0.5s cubic-bezier(0.6, -0.28, 0.735, 0.045);\n}\n.fade-enter[data-v-514744a6], .fade-leave-to[data-v-514744a6] {\n  opacity: 0;\n}\n.fade-enter-active[data-v-514744a6] {\n  transition: all 0.5s cubic-bezier(0.68, -0.55, 0.265, 1.55);\n}\n", ""]);
