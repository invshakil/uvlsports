                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p>
                                        Submitted At: {{ $articleData['created_at'] }}
                                    </p>
                                    <p>
                                        Please let admin panel know, whom of you will be working the this article.
                                    </p>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <a href="{{ url('admin/edit-article/'.$articleData['article_id']) }}"
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">
                                        © 2019 {{ env('APP_NAME') }}. All rights reserved.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
