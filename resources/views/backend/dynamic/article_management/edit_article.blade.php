            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h4 id="form-validation-basic-demo">Edit Article Information</h4>
                                                        ...
                                                        <select name="category_id[]" multiple
                                                            ...
                                                            @foreach($categories as $category)
                                                                <option value="{{ $category->id }}"
                                                                        {{ ( in_array($category->id, old("category_id", explode(',', $info->category_id))) ? "selected":"") }}>{{ $category->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select style="width: 100%" name="user_id"
                                                            ...
                                                            @foreach($users as $user)
                                                                <option value="{{ $user->id }}"
                                                                        @if($user->id == old('user_id', $info->user_id)) selected @endif>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-control custom-radio">
                                                            <input id="radio1" name="status" value="0" type="radio"
                                                                   ...
                                                                   @if(old('status', $info->status) == 0) checked @endif>
                                                        ...
                                                        <label class="custom-control custom-radio">
                                                            <input id="radio1" name="status" value="1" type="radio"
                                                                   class="custom-control-input"
                                                                   @if(old('status', $info->status) == 1) checked @endif>
                                                            <span class="custom-control-indicator"></span>
                                                ...
                                                <div class="card-block">
                                                    <div class="form-group">
                                                        <input type="text" name="tags" class="form-control"
                                                               id="tags" value="{{ old('tags', $info->tags) }}">
                                                        @if ($errors->has('tags'))
                                                            <div class="has-error">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-control custom-radio">
                                                            <input id="radio1" name="featured_status" value="0"
                                                                   type="radio"
                                                                   class="custom-control-input"
                                                                   @if(old('featured_status', $info->featured_status) == 0) checked @endif>
                                                            <span class="custom-control-indicator"></span>
                                                        ...
                                                        <label class="custom-control custom-radio">
                                                            <input id="radio1" name="featured_status" value="1"
                                                                   type="radio"
                                                                   class="custom-control-input"
                                                                   @if(old('featured_status', $info->featured_status) == 1) checked @endif>
                                                            <span class="custom-control-indicator"></span>
                                                ...
                                                <div class="card-block">
                                                    <div class="form-group">
                                                            <textarea name="meta_keyword" id="meta_keyword"
                                                                      rows="9"
                                                                      class="form-control">{{ old('meta_keyword', $info->meta_keyword) }}</textarea>
