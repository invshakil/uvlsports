                                            ...
                                            <div class="panel panel-default color-purple">
                                                ...
                                                <div class="card-block">
                                                    <div class="form-group">
                                                        ...
                                                        @if($info->image != '')
                                                            <img id="blah"
                                                                 src="{{ asset('image_upload/post_image/resized/'.$info->image) }}"
                                                        ...
                                                        <select name="category_id[]" multiple
                                                            ...
                                                            @foreach($categories as $category)
                                                                <option value="{{ $category->id }}"
                                                                        @php $cats = explode(',',$info->category_id) @endphp

                                                                        @foreach($cats as $cat)
                                                                        @if($category->id == $cat) selected @endif
                                                                        @endforeach
                                                        ...
                                                        <select style="width: 100%" name="user_id"
                                                            ...
                                                            @foreach($users as $user)
                                                                ...
                                                                <option value="{{ $user->id }}"
                                                                        @if($user->id == $info->user_id) selected @endif>
                                                ...
                                                <div class="card-block">
                                                    <div class="form-group">
                                                        <textarea name="description" id="description"
                                                                  ...
                                                                  data-validation-error-msg="Description has to be an alphanumeric value (200-6000 chars)"
                                                ...
                                                <div class="card-block">
                                                    <div class="form-group">
                                                        <textarea name="meta_keyword" id="meta_keyword"
                                                                  class="form-control"
                                                                  title="" value="">{{ $info->meta_keyword }}</textarea>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-control custom-radio">
                                                            <input id="radio1" name="featured_status" value="0"
                                                                   type="radio"
                                                                   class="custom-control-input"
                                                                   @if($info->featured_status ==0) checked @endif>
                                                            <span class="custom-control-indicator"></span>
                                                            <span class="custom-control-description">No</span>
                                                        </label>
                                                        <label class="custom-control custom-radio">
                                                            <input id="radio1" name="featured_status" value="1"
                                                                   type="radio" @if($info->featured_status ==1) checked
                                                                   @endif
                                                                   class="custom-control-input">
                                                            <span class="custom-control-indicator"></span>
